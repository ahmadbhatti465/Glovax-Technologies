      ...
      <main className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            {items.map((item) => (
              <button
                ...
                className={`w-full text-left px-4 py-3 rounded-lg text-sm font-medium transition-colors ${
                  activeKey === item.key
                    ? "bg-[#1EDAC6]/10 text-[#1EDAC6] border border-[#1EDAC6]/20"
          ...
          <div className="lg:col-span-3">
            {activeItem && (
              <div className="bg-surface-raised border border-[#1EDAC6]/10 rounded-xl p-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      onClick={saveActive}
                      disabled={saving}
                      className="flex items-center gap-2 px-4 py-2 bg-[#1EDAC6] text-black text-sm font-medium rounded-lg hover:bg-[#34F5E2] transition-colors disabled:opacity-50"
                    >
  ...
  if (typeof value === "string") {
    return (
      <textarea
        ...
        className="w-full bg-background border border-white/10 rounded-lg p-3 text-sm text-white focus:border-[#1EDAC6]/50 focus:outline-none"
        rows={6}
      />
    );
  }
      ...
      return (
        <div className="space-y-2">
          {(value as string[]).map((item, index) => (
            <div key={index} className="flex items-center gap-2">
              <input
                ...
                className="flex-1 bg-background border border-white/10 rounded-lg p-2.5 text-sm text-white focus:border-[#1EDAC6]/50 focus:outline-none"
              />
              <button
                onClick={() => {
                  const arr = [...(value as string[])];
          ...
          <button
            ...
            className="flex items-center gap-2 text-sm text-[#1EDAC6] hover:text-[#34F5E2] mt-2"
          >
    ...
    return (
      <div className="space-y-4">
        {(value as Record<string, unknown>[]).map((item, index) => (
          <div key={index} className="bg-background border border-white/10 rounded-lg p-4 relative">
            <button
              onClick={() => {
        ...
        <div key={key}>
          ...
          {typeof val === "string" && (
            <input
              ...
              className="w-full bg-background border border-white/10 rounded-lg p-2.5 text-sm text-white focus:border-[#1EDAC6]/50 focus:outline-none"
            />
          )}
          {typeof val === "number" && (
            <input
          ...
          {typeof val === "boolean" && (
            <input
              ...
              className="w-5 h-5 accent-[#1EDAC6]"
            />
          )}
          {Array.isArray(val) && (
          ...
          {typeof val === "object" && val !== null && !Array.isArray(val) && (
            <div className="bg-background border border-white/10 rounded-lg p-3 mt-1">
              <ObjectEditor
