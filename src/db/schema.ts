...
export const portfolioItems = sqliteTable("portfolio_items", {
  ...
  projectYear: text("project_year"),
  location: text("location"),
  featured: integer("featured", { mode: "boolean" }).notNull().default(false),
  status: text("status").notNull().default("published"),
  challenge: text("challenge"),
  solution: text("solution"),
  process: text("process", { mode: "json" }).$type<string[]>().notNull().default([]),
  results: text("results", { mode: "json" }).$type<string[]>().notNull().default([]),
  keyFeatures: text("key_features", { mode: "json" }).$type<string[]>().notNull().default([]),
  ...
  testimonialRating: integer("testimonial_rating").default(5),
  image: text("image"),
  imageAlt: text("image_alt"),
  imageTitle: text("image_title"),
  imageCaption: text("image_caption"),
  gallery: text("gallery", { mode: "json" }).$type<{ url: string; alt?: string; title?: string; caption?: string }[]>().notNull().default([]),
  relatedProjects: text("related_projects", { mode: "json" }).$type<string[]>().notNull().default([]),
